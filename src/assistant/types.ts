...
export interface ModelAdapter {
  ...
  route(userText: string, tools: AssistantTool[], history: ChatTurn[]): Promise<RouteDecision>;
  ...
  /** Free-form reply; streams deltas via `onDelta` and resolves the full text. */
  chat(userText: string, history: ChatTurn[], onDelta?: (delta: string) => void): Promise<string>;
