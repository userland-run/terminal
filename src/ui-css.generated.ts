...
/* runner-tier facet: chip row (like categories) + per-app tier badge */
.catalog-runners {
  display: flex;
  flex-wrap: wrap;
  gap: 4px;
...
.catalog-row.installed .catalog-tier { opacity: 0.6; }

/* per-tier colors — the badge pill (.catalog-tier) and the facet chip text tint */
.catalog-tier.catalog-tier-riscv { color: #b9a6ef; background: rgba(169, 132, 245, 0.13); border-color: rgba(169, 132, 245, 0.28); }
.catalog-tier.catalog-tier-node  { color: #7fca9b; background: rgba(74, 176, 110, 0.13);  border-color: rgba(74, 176, 110, 0.30); }
.catalog-tier.catalog-tier-wasm  { color: #7fb0e6; background: rgba(90, 150, 230, 0.14);  border-color: rgba(90, 150, 230, 0.32); }
.catalog-tier.catalog-tier-boa   { color: #e0b070; background: rgba(220, 160, 70, 0.13);  border-color: rgba(220, 160, 70, 0.30); }
.catalog-chip.catalog-tier-riscv { color: #b9a6ef; }
.catalog-chip.catalog-tier-node  { color: #7fca9b; }
.catalog-chip.catalog-tier-wasm  { color: #7fb0e6; }
.catalog-chip.catalog-tier-boa   { color: #e0b070; }
